...
pub const LocateSearchType = @import("tables/locate_search.zig").LocateSearchType;
...
pub const MemoryDescriptor = @import("tables/services/memory.zig").MemoryDescriptor;
